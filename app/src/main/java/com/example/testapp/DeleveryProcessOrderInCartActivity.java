...
public class DeleveryProcessOrderInCartActivity extends AppCompatActivity {
    ...
    private void setEvent() {
        ...
        getOrderById(token,UserOrderActivity.orderInCartID);
    ...
    private  void showStatusOrder(Integer status_id){
        ...
        // Dat thanh cong
            ...
            Glide.with(this)
                    ...
                    .into(tvStatus);
            tvLineStatus1.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
        }
        // Dang thuc hien
        else if (status_id ==2){
            ...
            Glide.with(this)
                    ...
                    .into(tvStatus);
            tvLineStatus1.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
            tvLineStatus2.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
        }
        // Dang giao hang
        else if (status_id == 3){
            ...
            tvLineStatus1.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
            tvLineStatus2.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
            tvLineStatus3.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
        }
        // Giao thanh cong
        else if (status_id == 4) {
            ...
            tvLineStatus2.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
            tvLineStatus3.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
            tvLineStatus4.setBackgroundTintList(ContextCompat.getColorStateList(DeleveryProcessOrderInCartActivity.this, R.color.green));
        }
    }
