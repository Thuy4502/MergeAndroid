...
public class CouponDetailAdminActivity extends AppCompatActivity {
    ...
    String coupon_id, coupon_title, startDate, endDate, content;
    @Override
    ...
    protected void setEvent() {
        ...
        btnDisableCoupon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ApiService.apiService.disableCoupon(tokenStaff, coupon_id, coupon).enqueue(new Callback<ApiResponse>() {
                    @Override
